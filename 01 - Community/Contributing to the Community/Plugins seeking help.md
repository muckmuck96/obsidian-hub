...
- [[pseudocode-in-obs|Pseudocode]] - [Can’t be used with my iPad ](https://github.com/ytliu74/obsidian-pseudocode/issues/10)
...
- [[telegram-sync|Telegram Sync]] - [Enhancement: Add a option to use more bots](https://github.com/soberhacker/obsidian-telegram-sync/issues/71)
...
- [[attachment-management|Attachment Management]] - [Add command to "Rename attachments within current file"](https://github.com/trganda/obsidian-attachment-management/issues/29)
...
- [[email-block-plugin|Email Block]] - [New Mailto Button - Call for suggestions](https://github.com/joleaf/obsidian-email-block-plugin/issues/7)
...
- [[khoj|Khoj]] - [Test Windows install on amd machine](https://github.com/khoj-ai/khoj/issues/306)
- [[obsidian-linter|Linter]] - [FR: Add Rules from markdownlint](https://github.com/platers/obsidian-linter/issues/32)
...
- [[mathlinks|MathLinks]] - [Proper live-preview rendering in admonitions](https://github.com/zhaoshenzhai/obsidian-mathlinks/issues/22)
- [[mathlinks|MathLinks]] - [Links not opening whe leaf is not focused](https://github.com/zhaoshenzhai/obsidian-mathlinks/issues/21)
...
- [[obsidian-metatable|Metatable]] - [Can line breaks be supported?](https://github.com/arnau/obsidian-metatable/issues/54)
- [[obsidian-metatable|Metatable]] - [Bug when exporting pdf with pictures](https://github.com/arnau/obsidian-metatable/issues/30)
...
- [[open-gate|Open Gate]] - [[FR] Allow camera and microphone](https://github.com/nguyenvanduocit/obsidian-open-gate/issues/19)
...
- [[rss-reader|RSS Reader]] - [Translate into multiple languages](https://github.com/joethei/obsidian-rss/issues/43)
- [[obsidian-raindrop-highlights|Raindrop Highlights]] - [When using append mode, if making a new highlight in an article already synced to Obsidian, **all** highlights will be synced, durplicating previously highlights that were previously synced](https://github.com/kaiiiz/obsidian-raindrop-highlights-plugin/issues/47)
...
- [[obsidian-task-marker|Task Marker]] - [Mark Task menu should arrow key navigation  ](https://github.com/wenlzhang/obsidian-task-marker/issues/20)
- [[obsidian-tasks-plugin|Tasks]] - [Bug report: Created date not automatically added when list contains `- [ ]`](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/2025)
...
- [[khoj|Khoj]] - [Installing requires the `--break-system-packages` flag for `pip`](https://github.com/khoj-ai/khoj/issues/276)
