...
- [[canvas-links|Canvas Links]]: Show "link" between canvas and embedded file in Obsidian.
...
- [[obsidian-importer|Importer]]: Import notes from other apps like Evernote.
...
- [[obsidian-clipper|Obsidian Clipper]]: This plugin helps you capture highlights from the web.
...
- [[restore-tab-key|Restore Tab Key]]: Restore tab key behaviour: tab key inserts a tab, the way it should be.
...
- [[search-obsidian-in-google|Search Obsidian in Google]]: A simple plugin to search the current note in Google (or other search engines).
